...
public class UserDAOImpl implements UserDAO{
	...
	public List<Doctor> getDoctorList(String day) throws SQLException {
		...
		String sql = "SELECT hospital_id, name, specialization ,daysOfAvailability FROM "
	...
	public int saveAppointment(Appointment appointment) throws SQLException {
		int save = 0;
		String sql = "INSERT into appointment (user_id, hospital_id, timeslot, date_of_appointment) VALUES (?,?,?,?)";
		System.out.println(appointment.getUser_id()+" "+appointment.getHospital_id()+" "+appointment.getTimeSlot());
		try{
			connection = connectionManager.connect();
			PreparedStatement stmt = connection.prepareStatement(sql);
