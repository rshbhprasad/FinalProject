...
<style type="text/css">
body{
 background-image:url("https://images.pexels.com/photos/1877288/pexels-photo-1877288.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940");
				...
				<c:forEach var="temp" items="${list}">
					<tr>
						<c:url var="book" value="/user/book">
							<c:param name="id" value="${temp.getHospitalID()}"></c:param>
						</c:url>
						<td>${temp.getName()}</td>
